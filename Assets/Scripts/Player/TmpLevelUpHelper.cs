...
public class TmpLevelUpHelper
{
    ...
    public void WeaponAttackPowerUp(int value = 2)
    {
        BaseProjectile.attackPowerUp += value;
        GameManager.Instance.hudManager.LevelUpHintUpdate("공격력 증가!");
    }

    public void WeaponAttackSpeedUp(float value = 0.97f)
    {
    ...
    public void TowerAttackSpeedUp(float value = 0.95f)
    {
